...
class _AlbumViewState extends State<AlbumView> {
  ...
  void initAsync(BuildContext) async {
  ...
  Widget build(BuildContext context) {
    if (_isLoading == true)
      ...
      return Scaffold(
        appBar: AppBar(
          title: _albums.length >1 ?  DropdownButton<String>(
            ...
            onChanged: (String newValue) async {
              ...
              YellowImagePicker.currentAlbumInfo.value.selectedAlbum = _selectedAlbum;
        ...
        body: ValueListenableBuilder(
          ...
          builder: (BuildContext context, CurrentAlbumInfo data, Widget child) {
                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => ViewerPage(data.media[index])),
                    );
                  },
                  child: Container(
