...
import 'package:yellow/src/widget/camera/bottom_bar.dart';
import 'package:yellow/src/widget/camera/camera_preview.dart';
...
class CameraExampleHome extends StatefulWidget {
  ...
  CameraExampleHome({this.randomPhotoName = true});
